  ...
  return (
    <div className="min-h-screen">
      <MaxWidthWrapper className="flex flex-col items-center justify-center tracking-tight">
        ...
        <h1 className="text-4xl md:text-8xl text-center font-luckiest mb-9 md:mb-16"><span className="text-green-500">Le</span>gacy <span className="text-green-500">Roleplay</span></h1>
        <div className="w-full flex justify-center md:justify-between">
          <div className="relative hidden md:flex justify-center items-center w-[28rem]">
            <img className="absolute -z-10 -rotate-12  md:w-[400px] drop-shadow-2xl" src="/icons/LPRP.png" alt="" />
          </div>
