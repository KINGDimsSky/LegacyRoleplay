  ...
  return (
    <div className="flex flex-col">
      ...
      <MaxWidthWrapper className="flex flex-col items-center justify-center min-h-screen">
        <h2 className="text-white font-extrabold text-[2.15rem] md:text-7xl lg:text-8xl mb-2">HIGH QUALITY SERVER</h2>
        <h2 className="text-white font-extrabold text-4xl md:text-7xl lg:text-8xl mb-4">LEGACY ROLEPLAY</h2>
