     ...
     <div className="flex flex-col">
      <div className="relative flex flex-col min-h-screen">
        ...
        <MaxWidthWrapper className="flex flex-col items-center justify-center min-h-screen">
          <h2 className="text-white font-extrabold text-[1.95rem] lg:text-8xl md:text-5xl mb-2">
            HIGH QUALITY SERVER
          </h2>
          ...
          <div className="flex gap-2 mb-4">
            ...
            <Button size="icon" className="p-6 hover:bg-green-600">
              <Download style={{ width: "26px", height: "26px" }} />
            </Button>
          </div>
        </MaxWidthWrapper>
      </div>
